...
<body>
    <header>
        ...
        <div class="drop_menu">
            ...
            <div id="myDropdown" class="dropdown-content">
                <p class="nick"><?= $_SESSION['user'] ?></p> <!-- тут надо, чтоб вместо "User" указывался ник пользователя -->
                <a href="#">Статистика</a>
    ...
    <div class="content">
        <div class="container">
            <div class="descr">
                <h2>Добро пожаловать, <?= $_SESSION['user'] ?>!</h2> <!-- тут надо, чтоб вместо "User" указывался ник пользователя -->
            </div>
